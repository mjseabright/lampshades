...
A couple of helper files at the repo root, [geometry_functions.scad](geometry_functions.scad) and [mounting_functions.scad](mounting_functions.scad), hold shapes shared across multiple designs (polygons, center holes, foot-mounting holes). You generally shouldn't need to touch these unless you want to change how the lampshade is mounted.
